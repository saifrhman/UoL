...
motivating macro-F1 and Cohen's~$\kappa$ in §3.
...
\begin{itemize}
    ...
    \item Gradient norm clipped at 5.0 (RNN) and 1.0
    (Transformer) — Vaswani-recommended for from-scratch attention.
...
\paragraph{3.2~~Test-set results.}
...
\paragraph{3.3~~Confusion matrix and error analysis.}
